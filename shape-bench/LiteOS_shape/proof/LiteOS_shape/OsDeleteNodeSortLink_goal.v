...
forall (A: Type) (sortList_pre: Z) (l2: (@list (@DL_Node (@sortedLinkNode A)))) (l1: (@list (@DL_Node (@sortedLinkNode A)))) (a: A) (storeA: (Z -> (A -> Assertion))) (t: Z) (x: Z) (node_callee_pstNext: Z) (node_callee_pstPrev: Z) (PreH1 : (node_callee_pstPrev = 0)) (PreH2 : (node_callee_pstNext = 0)) ,
...
forall (A: Type) (sortList_pre: Z) (l2: (@list (@DL_Node (@sortedLinkNode A)))) (l1: (@list (@DL_Node (@sortedLinkNode A)))) (a: A) (storeA: (Z -> (A -> Assertion))) (x: Z) (node_callee_pstNext: Z) (node_callee_pstPrev: Z) (PreH1 : (node_callee_pstPrev = 0)) (PreH2 : (node_callee_pstNext = 0)) ,
...
Definition OsDeleteNodeSortLink_partial_solve_wit_1_pure := 
(
...
|--
  “ ((sortedLinkNodeMappingList ((app (l1) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (sortList_pre))) (l2)))))) = (app ((map (sortedLinkNodeMapping) (l1))) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (&((sortList_pre)  # "SortLinkList" ->ₛ "sortLinkNode")))) ((map (sortedLinkNodeMapping) (l2))))))) ”
) \/
(
forall (A: Type) (sortList_pre: Z) (l2: (@list (@DL_Node (@sortedLinkNode A)))) (l1: (@list (@DL_Node (@sortedLinkNode A)))) (a: A) (storeA: (Z -> (A -> Assertion))) (t: Z) (x: Z) ,
  (store_dll (storesortedLinkNode (storeA)) x (sortedLinkNodeMappingList ((app (l1) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (sortList_pre))) (l2)))))) )
  **  ((( &( "sortList" ) )) # Ptr  |-> sortList_pre)
|--
  “ ((sortedLinkNodeMappingList ((app (l1) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (sortList_pre))) (l2)))))) = (app ((map (sortedLinkNodeMapping) (l1))) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (&((sortList_pre)  # "SortLinkList" ->ₛ "sortLinkNode")))) ((map (sortedLinkNodeMapping) (l2))))))) ”
).

Definition OsDeleteNodeSortLink_partial_solve_wit_1_pure_split_goal_1 := 
forall (A: Type) (sortList_pre: Z) (l2: (@list (@DL_Node (@sortedLinkNode A)))) (l1: (@list (@DL_Node (@sortedLinkNode A)))) (a: A) (storeA: (Z -> (A -> Assertion))) (t: Z) (x: Z) ,
  (store_dll (storesortedLinkNode (storeA)) x (sortedLinkNodeMappingList ((app (l1) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (sortList_pre))) (l2)))))) )
  **  ((( &( "sortList" ) )) # Ptr  |-> sortList_pre)
|--
...
Definition OsDeleteNodeSortLink_partial_solve_wit_1_aux := 
forall (A: Type) (sortList_pre: Z) (l2: (@list (@DL_Node (@sortedLinkNode A)))) (l1: (@list (@DL_Node (@sortedLinkNode A)))) (a: A) (storeA: (Z -> (A -> Assertion))) (t: Z) (x: Z) ,
  (store_sorted_dll storeA x (app (l1) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (sortList_pre))) (l2)))) )
|--
  “ ((sortedLinkNodeMappingList ((app (l1) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (sortList_pre))) (l2)))))) = (app ((map (sortedLinkNodeMapping) (l1))) ((cons ((Build_DL_Node ((mksortedLinkNode (a) (t))) (&((sortList_pre)  # "SortLinkList" ->ₛ "sortLinkNode")))) ((map (sortedLinkNodeMapping) (l2))))))) ”
...
Definition OsDeleteNodeSortLink_partial_solve_wit_1 := OsDeleteNodeSortLink_partial_solve_wit_1_pure -> OsDeleteNodeSortLink_partial_solve_wit_1_aux.
...
Axiom proof_of_OsDeleteNodeSortLink_partial_solve_wit_1_pure : OsDeleteNodeSortLink_partial_solve_wit_1_pure.
